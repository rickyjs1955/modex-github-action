...
It is a thin wrapper over [`@modexagents/core`](https://www.npmjs.com/package/@modexagents/core) —
...
The action depends on the **published** `@modexagents/core`. Before that package is
